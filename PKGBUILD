...
install=matlab.install
source=($pkgname.tar $pkgname.fik $pkgname.lic $pkgname.sysusers)
b2sums=(SKIP SKIP SKIP aabf56a53c319284e6187b88fc8054e01f105c8274fc7bbfe67e687fbeda80b26cbee78e8d3b7dc0333c6c26b2491db934f052c555809cde1ba8a6649eef72ce)
...
package() {
  ...
  install -dm775 "$(dirname "$pkgdir/$_instdir")"
  ...
  msg2 "Creating matlab group and setting permissions..."
